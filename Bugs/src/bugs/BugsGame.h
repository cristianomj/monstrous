...
static const wstring	W_SPLASH_SCREEN_PATH	= L"data/gui/overlays/monstrous2_splash_screen_overlay.png";
static const wstring	W_MAIN_MENU_PATH		= L"data/gui/overlays/monstrous_main_menu_overlay.png";
